...
//	    private final String RETURN_URL = "http://localhost:8080/SCSMS/payController/returnUrl";
	    private final String RETURN_URL = "http://localhost:8080/SCSMS/payController/alipaytest";
	...
	public String alipaytest(HttpServletRequest request, HttpServletResponse response,HttpSession session)
			throws IOException, AlipayApiException {
		System.out.println("=================================同步回调=====================================");
		// 获取支付宝GET过来反馈信息
//		Map<String, String> params = new HashMap<String, String>();
...
//		if(signVerified){
		  Random r = new Random();
			// 商户订单号
//			String out_trade_no = new String(request.getParameter("out_trade_no").getBytes("ISO-8859-1"), "UTF-8");
			String out_trade_no = (String) session.getAttribute("payid");;

			// 支付宝交易号
//			String trade_no = new String(request.getParameter("trade_no").getBytes("ISO-8859-1"), "UTF-8");
			String trade_no = String.valueOf(r.nextLong());
