		...
		<div id="addBox">
			<form class="layui-form layui-form-pane" action="" method="post">
				<div class="layui-form-item">
					<label class="layui-form-label">添加教室</label>
					<div class="layui-input-block">
						<input type="text" name="name" required lay-verify="required"
							placeholder="请输入教室名" autocomplete="off" class="layui-input">
					</div>
				</div>
				<div class="layui-form-item layui-form-text">
					<label class="layui-form-label">教室地址</label>
					<div class="layui-input-block">
						<textarea name="location" placeholder="请输入内容" required lay-verify="required"
							class="layui-textarea" style="max-height:150px;"></textarea>
					</div>
				</div>
				<div class="layui-form-item">
					<div class="layui-input-block">
		...
		<div id="editBox">
			<form class="layui-form layui-form-pane" action="" lay-filter="form2">
				<div class="layui-form-item">
					...
					<div class="layui-form-mid layui-word-aux">注:教室编号无法修改</div>
				</div>
	...
	<script type="text/javascript">
		...
		layui.use('form', function () {
			...
			form.on('submit(form1)', function (data) {
				...
				$.ajax({
					type: "POST",
					url: "roomController/insert",
					data: { "roomName": formdata.name, "location": formdata.location },
					dataType: "JSON",
		...
		function room_edit(id) {
			...
			layui.use('form', function () {
				...
				form.on('submit(form2)', function (data) {
					...
					$.ajax({
						type: "POST",
						url: "roomController/update",
						data: { "id": formdata.id, "roomName": formdata.name, "location": formdata.location },
						dataType: "JSON",
						success: function (data) {
							if (data.result == "yes") {
								layer.closeAll();
